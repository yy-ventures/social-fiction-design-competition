...
const SFDCInputs = () => {
    ...
    const [fileAcceptStr, setFileAcceptStr] = useState("audio/*, video/mp4,video/x-m4v, video/quicktime")
    ...
    const formatAccept = {
        ...
        writing: "application/msword, application/vnd.ms-excel, .doc, .docx, application/pdf,application/vnd.ms-powerpoint,application/vnd.openxmlformats-officedocument.presentationml.slideshow,application/vnd.openxmlformats-officedocument.presentationml.presentation",
