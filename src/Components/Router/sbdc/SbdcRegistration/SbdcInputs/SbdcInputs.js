        ...
        <>
          <div className="row">
            ...
            <div className="col-lg-6">
              <input
                type="url"
                {...register("OptionalLink" + additionalLink)}
              />
            </div>
      ...
      <div className="row">
        ...
        <div className="col-lg-8">
          ...
          >
            ...
            <div className="mt-5">
              <h5>
                How is your Social Business reducing carbon emission, creating
            ...
            <div className="mt-5 link-input">
              <h5>
                Is there a way through which we can learn more about your Social
                Business/Idea? <br />
                <span className="bold">
            ...
            <div className="registration-footer mt-2">
              <p>
                ***Submit an introduction to your team and Social Business idea.
                Mention the problem you aim to address and the proposed
                solution. <br /> Briefly highlight any relevant information
                regarding Beneficiaries, Value Proposition, Achievements,
