                ...
                <div className="row">
                    ...
                    <div className="col-lg-6">
                        ...
                        <div className="who-can-apply-list">
                            <ul>
                                <li>You are an individual or a team of 5 with a creative but viable social business idea to solve any of the following issues: Environment and Climate Change, Micro-credit, Agriculture, Technology and Innovation, Waste, Circular Economy, Tourism, WASH, Employment, Sports, Health and Well-being.</li>
